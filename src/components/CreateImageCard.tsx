...
const CreateImageCard = () => {
  return (
    <div className="relative w-[236px] h-[273px] mx-auto">
      {/* Main Card Container */}
      <div className="relative w-full h-full rounded-3xl border border-[#E2E8FF] overflow-hidden"
           style={{
             background: `
        ...
        <div className="absolute top-[50px] left-[38px] w-[162px] h-[142px]">
          {/* Back layer */}
          <div className="absolute w-[140px] h-[110px] left-0 top-0 rounded-3xl"
               style={{
                 background: `
                   radial-gradient(50% 50% at 50% 50%, rgba(118, 146, 255, 0.06) 80.55%, rgba(122, 150, 255, 0.024) 100%),
        ...
        <div className="absolute left-[20px] top-[218px] w-[138px] h-[32px] flex items-center">
          <span className="text-[18px] font-semibold leading-[90%] text-[#141C23]"
        ...
        {/* Arrow Button */}
        <div className="absolute w-[32px] h-[32px] left-[184px] top-[218px] rounded-full"
             style={{
               boxShadow: `
