...
const ModernCard = ({ title = "Create an Image", onClick, className }: ModernCardProps) => {
  return (
    <div 
      className={cn(
        "group cursor-pointer relative w-[236px] h-[273px] mx-auto",
        className
      )}
      onClick={onClick}
    >
      ...
      <div className="relative w-full h-full glass-card overflow-hidden">
        ...
        {/* Background Frames - Complex Glass Layers */}
        ...
        {/* Glass Button */}
        <div className="glass-button absolute left-[184px] top-[218px] z-10">
